# دليل تحويل موقع "ختم" إلى تطبيق جوال ومنصة متكاملة 📱

أهلاً بك يا فيصل! لقد تم إعداد هذا الدليل الشامل ليجيب عن طلبك بدقة، حيث يحتوي على:
...
```
Subspace / Capacitor CLI adds local targets:
```bash
npx cap add android
npx cap add ios
```
...
class KhatmApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: const Color(0xFF1E3050),
        fontFamily: 'Cairo',
      ),
